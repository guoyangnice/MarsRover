...
public class MarsRoverTest {
    ...
    @Test
    public void should_return_x_0_y_0_N_when_receive_BMBM_command_give_mars_rover_with_init_place_x_0_y_0_N() {
        MarsRover marsRover = new MarsRover(new MarsRoverPosition(0 ,0 , "N"));
    ...
    @Test
    public void should_return_x_0_y_0_N_when_receive_F_command_give_mars_rover_with_init_place_x_0_y_0_N() {
        MarsRover marsRover = new MarsRover(new MarsRoverPosition(0 ,0 , "N"));

        MarsRoverPosition marsRoverPosition = marsRover.receive("F");
    ...
    @Test
    public void should_return_x_0_y_2_N_when_receive_FM_command_give_mars_rover_with_init_place_x_0_y_0_N() {
        MarsRover marsRover = new MarsRover(new MarsRoverPosition(0 ,0 , "N"));

        MarsRoverPosition marsRoverPosition = marsRover.receive("FM");
    ...
    @Test
    public void should_return_x_0_y_f2_N_when_receive_F_command_give_mars_rover_with_init_place_x_0_y_0_N() {
        MarsRover marsRover = new MarsRover(new MarsRoverPosition(0 ,0 , "N"));

        MarsRoverPosition marsRoverPosition = marsRover.receive("BFM");
    ...
    @Test
    public void should_return_x_0_y_1_N_when_receive_FL_command_give_mars_rover_with_init_place_x_0_y_0_N() {
        MarsRover marsRover = new MarsRover(new MarsRoverPosition(0 ,0 , "N"));
    ...
    @Test
    public void should_return_x_0_y_f2_N_when_receive_FMFM_command_give_mars_rover_with_init_place_x_0_y_0_N() {
        MarsRover marsRover = new MarsRover(new MarsRoverPosition(0 ,0 , "N"));

        MarsRoverPosition marsRoverPosition = marsRover.receive("FMFM");
